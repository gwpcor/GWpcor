  ...
  ##### a function for geographically weighted partial correlation 
  ##### citation:	Percival J. and Tsutsumida N. (in printing) Geographically weighted partial correlation for spatial analysis GI_forum Journal.
  ##### uploaded on Github: https://github.com/naru-T/GWpcor.git
  ##### version 1.0 (28 June 2017)

  gwpcor <- function (sdata, summary.locat, vars, method = c("pearson", "kendall", "spearman"), kernel = "bisquare", adaptive = FALSE, 
    ...
    res <- list(SDF = SDF, vars = vars, method = method, kernel = kernel, adaptive = adaptive, 
